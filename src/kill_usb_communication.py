#!/usr/bin/python3
# C:\Work\Python\HID_Util\src\kill_usb_communication.py
# based on bsl.py

# this will kill the usb communication from Prime device by sending bad packet (long length)
# the packet found to do the trick from wireshark:
# 3f 3e 86 00 00 01 86 00 00 01 86 00 00 01 86 00 00 01 04 00 00 00 86 00 00 01 86 00 00 01 86 00 00 01 86 00 00 01 86 00 00 01 88 01 00 00 01 86 00 00 01 86 00 00 01 86 00 00 01 86 00 00 01 86                  
# 3f3e8600000186000001860000018600000104000000860000018600000186000001860000018600000188010000018600000186000001860000018600000186
...
WRITE_DATA_CMD_BAD_COMMAND_1       = bytes.fromhex("3f3e8600000186000001860000018600000104000000860000018600000186000001860000018600000188010000018600000186000001860000018600000186")
...
#            special_cmd = 0
            ...
            if PRODUCT_ID in PRODUCT_ID_types:
                ...
                WRITE_DATA = WRITE_DATA_CMD_BAD_COMMAND_1
                print("special_cmd A -> WRITE_DATA_CMD_BAD_COMMAND_1")
                device.write(WRITE_DATA)
            else:
...
#            WRITE_DATA = DEFAULT_WRITE_DATA
        ...
        if WRITE_DATA == WRITE_DATA_CMD_BAD_COMMAND_1:
            break
