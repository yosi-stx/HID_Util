#!/usr/bin/python3
# file:   C:\Work\Python\HID_Util\src\lines_from_wireshark.py
# based on:   C:\Work\Python\HID_Util\src\lines_from_log.py
# date: 11-08-21
...
YAT_format = open("C:\Work\From_Gal\WireShark\wireshark_in_yat_format.txt")
