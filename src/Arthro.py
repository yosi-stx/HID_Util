...
def board_type_button_callback():
    print("TBD - button not used yet by Arthro GUI")
    return
    global special_cmd
    special_cmd = 'S'
...
#    row += 1
    ...
    temp_widget = tk.Button(frame,text ="TBD (not used yet)",command = board_type_button_callback)
